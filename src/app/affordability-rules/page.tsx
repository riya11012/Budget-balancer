  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-10">
      <div className="mx-auto max-w-2xl">
        <h1 className="text-3xl font-bold">Affordability Rules</h1>
        ...
        >
          <div>
            <label className="font-medium">Salary Spending Limit (%)</label>
            <input
              type="number"
          ...
          <div>
            <label className="font-medium">Savings Spending Limit (%)</label>
            <input
              type="number"
